...
const getLocationInfo = async () => {
  try {
    ...
    const fetchResult1 = await fetch(
      `http://api.weatherapi.com/v1/current.json?key=94b25103b10948d693083138241610&q=${responseBody.latitude},${responseBody.longitude}&aqi=no`
    );
    ...
    cityName.textContent = `${responseBody1.location.name}, ${responseBody.country_code}`;
